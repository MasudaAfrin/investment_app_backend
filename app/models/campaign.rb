...
class Campaign < ApplicationRecord
  ...
  validates :percentage_raised, :target_amount, numericality: { greater_than_or_equal_to: 0 }
  validates :investment_multiple, numericality: { greater_than_or_equal_to: 1 }
